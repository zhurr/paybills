        ...
        <section class="table-wrap"
            ...
            <div class="table-box">
                <YwTable :tableTitles="tableTitles"
                         v-if="resetComponent"
                         :option="{'selfClass':'table-line no-border only-descending',sort:{type:'dynamic',order:'descending',default:{prop: 'cpmMAX', order: 'descending'}}}"
                         @sortTable="sortTable"
    ...
    export default {
        ...
        methods: {
            ...
            getTableDatas() {
                ...
                this.tableTitles = [
                    { name: 'name', title: `省(市)`, style: { isHtml: true, width: 150, } },
