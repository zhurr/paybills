  ...
  <div class="container clearfix">
    <section class="log-wrap">
      ...
      <span class="title small">
        {{monthlyTime.split('-')[0]}}年{{monthlyTime.split('-')[1]}}月IT云资源均峰值利用率
      </span>
    </section>
    ...
    <section class="main-wrap main-chart">
      <div class="main">
        ...
        <div class="right"
             style="width:65%">
          <page3_2 style="width:100%;height:50%"></page3_2>
          <page3_3 style="width:100%;height:50%"></page3_3>
        </div>
      </div>
    </section>
  </div>
...
export default {
  components: {
    page3_1: () => import('@/views/month/page3-1.vue'),
    page3_2: () => import('@/views/month/page3-2.vue'),
    page3_3: () => import('@/views/month/page3-3.vue'),
